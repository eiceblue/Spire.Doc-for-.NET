...
Namespace EmbedNoninstalledFonts
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			' Create a new list to store PrivateFontPath objects
			Dim fonts As New List(Of PrivateFontPath)()
			' Add a PrivateFontPath object to the list with the specified font name and file path
			fonts.Add(New PrivateFontPath("PT Serif Caption", "..\..\..\..\..\..\..\Data\PT_Serif-Caption-Web-Regular.ttf"))
			' Set the PrivateFontPaths property of the parameters to the created list
