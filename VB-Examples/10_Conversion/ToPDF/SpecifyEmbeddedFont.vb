...
Namespace SpecifyEmbeddedFont
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			' Create a new List to store the embedded font name
			Dim part As New List(Of String)()
			part.Add("PT Serif Caption")

			' Set the list of embedded font names in the PDF conversion parameters
			parms.EmbeddedFontNameList = part

			' Save the document to a PDF file with the specified embedded font settings
