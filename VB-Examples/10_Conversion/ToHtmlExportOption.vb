...
Namespace ToHtmlExportOption
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			' Set the CSS style sheet file name and type for HTML export
			document.HtmlExportOptions.CssStyleSheetFileName = "sample.css"
			document.HtmlExportOptions.CssStyleSheetType = CssStyleSheetType.External

			' Specify that the images should not be embedded in the HTML file
			document.HtmlExportOptions.ImageEmbedded = False

			' Set the path for the images referenced in the HTML file
			document.HtmlExportOptions.ImagesPath = "Images"

			' Specify that input text form fields should be exported as text in the HTML
