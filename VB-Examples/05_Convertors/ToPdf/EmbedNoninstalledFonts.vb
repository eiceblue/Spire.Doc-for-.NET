...
Namespace EmbedNoninstalledFonts
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			'The method shows how to embed the non-installed fonts
            Dim parts As New List(Of PrivateFontPath)
            Dim path As New PrivateFontPath()
            path.FontPath = "..\..\..\..\..\..\..\Data\calibri.ttf"
            parts.Add(path)
            Dim parms As New ToPdfParameterList()
            parms.PrivateFontPaths = parts
