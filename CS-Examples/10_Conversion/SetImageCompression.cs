...
namespace SetImageCompression
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
			...
			document.LoadFromFile(@"..\..\..\..\..\..\..\Data\ImageTemplate.docx");
            ...
            document.SaveToFile("SetImageCompression.pdf", toPdfParameterList);

			// Dispose of the Document object to free up resources
			document.Dispose();

            //Launching the pdf reader to open.
            FileViewer("SetImageCompression.pdf");
        }
        ...
        private void InitializeComponent()
        {
            ...
            // pictureBox1
            // 
            this.pictureBox1.Image = global::SetImageCompression.Properties.Resources.Word;
            ...
            this.Text = "Set image compression in Word to PDF conversion";
